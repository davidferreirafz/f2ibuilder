...
/*                                                                           */
/*****************************************************************************/
package com.dukitan.f2ibuilder.application.controller.command.checkbox;
...
public class UseAlphaCommand extends CheckBoxCommand
{   
    public UseAlphaCommand(Options options, FontText fontText)
    {
    ...
    protected void action(JCheckBoxMenuItem checkbox)
    {
        ...
        options.setAlpha(state);
        mediator.selectedUseAlpha(state);
    }   
}
